...
function adminAuth(req, res, next) {
  const auth = req.headers['authorization'] || req.query.auth || req.body.auth || req.session_auth;
  if (auth === '123') return next();
  // Check cookie
...
app.post('/admin/edit/:id', adminAuth, (req, res) => {
  ...
  db.run(
    ...
    [title_he, title_en, technique_he, technique_en, year, size, category, req.params.id],
